...
func TestCLI_ImportCommands(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			command:     []string{"import", "postman", "../../testdata/complex-postman.json"},
			inputFile:   "../../testdata/complex-postman.json",
			expectError: false,
		},
		{
			name:        "Import Newman collection",
			command:     []string{"import", "newman", "../../testdata/complex-postman.json"},
			inputFile:   "../../testdata/complex-postman.json",
			expectError: false,
		},
		{
			name:        "Import Bruno collection",
			command:     []string{"import", "bruno", "../../testdata/complex-bruno.json"},
			inputFile:   "../../testdata/complex-bruno.json",
			expectError: false,
		},
		{
			name:        "Import Insomnia collection",
			command:     []string{"import", "insomnia", "../../testdata/complex-insomnia.json"},
			inputFile:   "../../testdata/complex-insomnia.json",
			expectError: false,
		},
		{
			name:        "Import HAR file",
			command:     []string{"import", "har", "../../testdata/complex.har"},
			inputFile:   "../../testdata/complex.har",
			expectError: false,
		},
		{
			name:        "Import OpenAPI spec",
			command:     []string{"import", "openapi", "../../testdata/complex-openapi.yaml"},
			inputFile:   "../../testdata/complex-openapi.yaml",
			expectError: false,
		},
		{
			name:        "Import REST Client file",
			command:     []string{"import", "restclient", "../../testdata/sample.http"},
